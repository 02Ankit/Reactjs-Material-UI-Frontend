...
// crearte object from motion 
  ...
  const style = {"text-align": "justify"}
  ...
  return (
    ...
    <div className="i-left">
        ...
        <span style={style}>
        NoDoubts  Academy is a platform which provides  personal tutors to school students to help  them in studies while creating employment for youth. Because every child is different and need personal attention and care, we provide subject specific mentors to up-skill your child by strengthening their foundation cogent. We are revolutionizing the vision of tutoring services, so that all children should have equal opportunities to excel.
        NoDoubts Academy is a platform which provides personal tutors to school students to help them in studies while creating employment for youth. Because every child is different and need personal attention and care, we provide subject specific mentors to up-skill your child by strengthening their foundation cogent. We are revolutionizing the vision of tutoring services, so that all children should have equal opportunities to excel.  
       </span>
