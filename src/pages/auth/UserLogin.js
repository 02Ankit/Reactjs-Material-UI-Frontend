  ...
  return (
    ...
    <Box sx={{mx:2}}>
        <Box component='form' noValidate sx={{ mt:1, mx:2 }} id='login-form' onSubmit={handleSubmit}>
                ...
                {server_error.email ? <Typography style={{fontSize:12,color:'red', paddingLeft:10}}>User Field is Empty</Typography> : "" }
                ...
                {server_error.password ? <Typography style={{fontSize:12,color:'red', paddingLeft:10}}>Password Field is Empty</Typography> : "" }
