      ...
      {userData.is_admin !== true ? listItemUserData.map((item, i) => (
        ...
        >
            <ListItem
              ...
              >
                <ListItemIcon ><span className={classes.listItemText}>{item.icon}</span></ListItemIcon>
                <ListItemText ><span className={classes.listItemText}>{item.label}</span></ListItemText>
            </ListItem>
        </Button>
        ...
        >
            <ListItem
              ...
              activeclassname={classes.activeNavlinks}
            >
                  <ListItemIcon ><span className={classes.listItemText}>{item.icon}</span>
                  </ListItemIcon>
                  <ListItemText ><span className={classes.listItemText}>{item.label}</span>
                  </ListItemText>
            </ListItem>
        </Button>
      ))}
